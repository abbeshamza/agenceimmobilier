...
use Application\ApplicationHomeBundle\Entity\Region;
use Application\ApplicationHomeBundle\Form\RegionType;
...
class RegionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ApplicationHomeBundle:Region')->findAll();

        return $this->render('ApplicationHomeBundle:Region:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ApplicationHomeBundle:Region:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ApplicationHomeBundle:Region')->find($id);
        ...
        return $this->render('ApplicationHomeBundle:Region:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ApplicationHomeBundle:Region:edit.html.twig', array(
            'entity'      => $entity,
